...
public class LQI_Computaion : MonoBehaviour
{
    ...
    //LQI Value between 0 and 255, where 255 is a very good connection and 0 a very bad one
    public int GetLqi(int txMode, double snr)
    {
